                               ...
                               Int_t numRanks)
{
   ...
   std::cout << "        MaxAbsDiff   = " << std::setw(20) << MaxAbsDiff   << "\n";
   std::cout << "        TotalAbsDiff = " << std::setw(20) << TotalAbsDiff << "\n";
   std::cout << "        MaxRelDiff   = " << std::setw(20) << MaxRelDiff   << "\n";
